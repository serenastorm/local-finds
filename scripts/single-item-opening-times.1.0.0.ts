import type { WeekDay, WeekdayWithOpeningTimes } from "../types/opening-times";
...
window.onload = function () {
  const singleLocations = document.querySelectorAll<HTMLElement>(
    `.single-item[data-location][data-hours]`
  );

  singleLocations.forEach((initialLocation) => {
